...
public class DeviceService extends Service {
	...
	final static int MSG_SEND_POINT3D_VALUE = -10;
	static final String ACTION_UPDATE_DASHBOARD_WITH_POINT3D = "com.mc.pha.ACTION_UPDATE_DASHBOARD_WITH_POINT3D";
	...
	private void createAccelerometerLogOnDevice() {
		...
		Log.e("AccelerometerLog", deviceRoot.toString());
	...
	public void onCharacteristicChanged(String uuidStr, byte[] rawValue) {
		...
		if (uuidStr.equals(UUID_ACC_DATA.toString())) {
			...
			// accelerometerReadingView.setText(msg);
			 ...
			 //TODO:  update someone - send v to Dashboard
			final Intent intent = new Intent(ACTION_UPDATE_DASHBOARD_WITH_POINT3D);
			
			intent.putExtra("X", v.x);
			intent.putExtra("Y", v.y);
			intent.putExtra("Z", v.z);
