...
public class GetImageTask extends AsyncTask<String, Void, String> {
    ...
    private GetImageResponseHandler delegate;

    private Map<String,String> postParams = null;

    public GetImageTask(Map<String, String> postParams, GetImageResponseHandler _delegate) {
    ...
    protected String doInBackground(String... urls) {
        ...
        try {
            ...
            final String basicAuth = "Basic " + Base64.encodeToString("<hotmail_username>:<api_key>".getBytes(), Base64.NO_WRAP);
    ...
    protected void onPostExecute(String result) {
        this.delegate.processGetImageResults(result);
    }
}
